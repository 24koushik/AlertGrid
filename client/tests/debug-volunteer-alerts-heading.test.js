...
test.describe("Debug Volunteer Alerts Heading", () => {
  test("check what heading is on the volunteer alerts page", async ({
    page,
  }) => {
    // Login as volunteer
    ...
    const allHeadings = await page
      ...
      .allInnerTexts();
    console.log("All headings on alerts page:", allHeadings);
    ...
    // Take a screenshot
    await page.screenshot({ path: "volunteer-alerts-heading.png" });
  });
});
