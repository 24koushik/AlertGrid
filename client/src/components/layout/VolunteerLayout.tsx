...
export function VolunteerLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    { name: "Response Center", href: "/volunteer", icon: Home },
    {
    ...
    { name: "My Tasks", href: "/volunteer/tasks", icon: CheckCircle },
    {
      ...
      href: "/volunteer/assistance",
      icon: FileText,
    },
    { name: "Operations Map", href: "/volunteer/map", icon: Map },
  ];

  const bottomNavigation = [
    { name: "Availability", href: "/volunteer/availability", icon: Clock },
      ...
      <div className="hidden md:flex w-64 flex-col bg-card border-r border-border">
        <div className="flex h-16 items-center px-6 border-b border-border">
          <div className="flex items-center">
            ...
            <span className="text-[10px] bg-brand-teal text-white px-2 py-0.5 rounded font-bold ml-3 mt-1 tracking-wider">
              RESPONDER
            </span>
          </div>
        </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden sm:flex items-center border-l pl-4 ml-2">
              <div className="mr-3 text-right">
                ...
                <p className="text-xs font-bold text-brand-aqua">VOLUNTEER</p>
              </div>
              <div className="h-8 w-8 rounded-full bg-brand-aqua/10 flex items-center justify-center text-brand-aqua font-bold">
